...
variable "project_name" {
  type        = string
  description = "The project name. Used it to name the RDS instance and add relevant tags"
}
########################
# Db configuration
########################
...
variable "storage_size" {
  type        = number
  default     = 10
  description = "The amount of storage to allocate to the RDS instance should be between 5 and 10 gigabytes"
